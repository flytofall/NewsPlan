package com.xprinter.newsplan.service;
...
import com.xprinter.newsplan.bean.ZhihuDailyStory;
...
public class CacheService extends Service {
    ...
    public void onCreate() {
        ...
        filter.addAction("com.charlie.zhihudaiy.LOCAL_BROADCAST");
        LocalBroadcastManager manager=LocalBroadcastManager.getInstance(this);
        manager.registerReceiver(new LocalRecier(),filter);
    }
    ...
    class LocalRecier extends BroadcastReceiver{
